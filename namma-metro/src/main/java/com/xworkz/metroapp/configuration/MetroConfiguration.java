...
@EnableWebMvc
@Configuration
@ComponentScan(basePackages ="com.xworkz.metroapp")
...
public class MetroConfiguration {
    ...
    public MetroConfiguration(){
        System.out.println("invoking the default constructor of MetroConfig");
    }
    ...
    public LocalContainerEntityManagerFactoryBean localContainerEntityManagerFactoryBean(){
      ...
      final LocalContainerEntityManagerFactoryBean bean=new LocalContainerEntityManagerFactoryBean();
        ...
        bean.setPackagesToScan(new String[]{"com.xworkz.metroapp.dto"});
